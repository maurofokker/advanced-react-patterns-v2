...
class Toggle extends React.Component {
  ...
  render() {
    ...
    return React.Children.map(this.props.children, childElement => {
      // clone element is responsible for passing these compound components (static On, Off)
      // the props they need to do their job
      return React.cloneElement(childElement, {
        on: this.state.on,        // clone react element and add extra props
        toggle: this.toggle,
      })
    })
  }
